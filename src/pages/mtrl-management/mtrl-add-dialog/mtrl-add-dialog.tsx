...
interface MtrlAddDialogProps {
  open: boolean;
  handleOpenMtrlAddDialog: (value: any) => void;
...
const MtrlAddDialog = ({
  open,
  handleSaveChangeAdd,
  handleOpenMtrlAddDialog,
}: MtrlAddDialogProps) => {
  const handleOnChangeOpen = (value: any) => {
    handleOpenMtrlAddDialog(value);
  };
  ...
  return (
    <>
      <Dialog open={open} onOpenChange={handleOnChangeOpen}>
        ...
        >
          <DialogHeader>
            <DialogTitle className="font-bold text-xl">Mtrl Add</DialogTitle>
