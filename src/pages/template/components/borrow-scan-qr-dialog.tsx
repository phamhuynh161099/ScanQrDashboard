...
interface BorrowScanQrDialogProps {
  open: boolean;
  haldleOpenBorrowScanQrDialog: (value: any) => void;
}

const BorrowScanQrDialog = ({
  open,
  haldleOpenBorrowScanQrDialog,
}: BorrowScanQrDialogProps) => {
  const handleOnChangeOpen = (value: any) => {
    haldleOpenBorrowScanQrDialog(value);
  };
...
export default BorrowScanQrDialog;
