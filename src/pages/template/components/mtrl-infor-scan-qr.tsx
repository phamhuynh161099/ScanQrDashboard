...
interface MtrlInforScanQrDialogProps {
  open: boolean;
  haldleOpenMtrlInforScanQrDialog: (value: any) => void;
}

const MtrlInforScanQrDialog = ({
  open,
  haldleOpenMtrlInforScanQrDialog,
}: MtrlInforScanQrDialogProps) => {
  const handleOnChangeOpen = (value: any) => {
    haldleOpenMtrlInforScanQrDialog(value);
  };
  ...
  return (
    <>
      <Dialog open={open} onOpenChange={handleOnChangeOpen}>
        ...
        >
          <DialogHeader>
            <DialogTitle>Scan MTRL</DialogTitle>
          </DialogHeader>
...
export default MtrlInforScanQrDialog;
