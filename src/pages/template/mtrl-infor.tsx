    ...
    <>
      <div className="min-h-[100%] w-full p-2">
        <div className="w-full rounded-xl shadow-xl border-2 p-2">
          <div className="flex justify-end">
            <Button onClick={()=>setOpenMtrlInforScanQrDialog(true)}>
              <ScanQrCode />
              Scan MTRL
            </Button>
          </div>
          ...
          <Card className="shadow-xl p-4">
            ...
            <CardContent className="mt-1 space-y-1 p-0">
              <div className="">
                ...
                <Badge className="rounded-full py-1 bg-gray-500 font-bold text-sm">Not Use</Badge>
              </div>
              ...
              <div className="mt-2">
                ...
                <Badge className="rounded-full py-1 bg-gray-500 font-bold text-sm">Borrow | Pham Huynh</Badge>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="mt-2">
            ...
            <CardContent className="space-y-1 p-4 pt-0">
              <div className="space-y-1">
                <Label className="text-sm font-semibold" htmlFor="mtrl_code">MTRL code</Label>
                <Input id="mtrl_code" value={mtrlInfor["mtrl_code"]} disabled />
              </div>
              <div className="space-y-1">
                <Label className="text-sm font-semibold" htmlFor="name">MTRL Name</Label>
                <Input id="name" defaultValue="" disabled />
              </div>
              {viewMore && (
                <>
                  <div className="space-y-1">
                    <Label className="text-sm font-semibold" htmlFor="name">Supplier</Label>
                    <Input id="name" defaultValue="" disabled />
                  </div>

                  <div className="space-y-1">
                    <Label className="text-sm font-semibold" htmlFor="name">Season</Label>
                    <Input id="name" defaultValue="" disabled />
                  </div>

                  <div className="space-y-1">
                    <Label className="text-sm font-semibold" htmlFor="name">Type</Label>
                    <Input id="name" defaultValue="" disabled />
                  </div>

                  <div className="space-y-1">
                    <Label className="text-sm font-semibold" htmlFor="name">EPM Rating</Label>
                    <Input id="name" defaultValue="" disabled />
                  </div>

                  <div className="space-y-1">
                    <Label className="text-sm font-semibold" htmlFor="name">Composition</Label>
                    <Input id="name" defaultValue="" disabled />
                  </div>

                  <div className="space-y-1">
                    <Label className="text-sm font-semibold" htmlFor="name">Width</Label>
                    <Input id="name" defaultValue="" disabled />
                  </div>

                  <div className="space-y-1">
                    <Label className="text-sm font-semibold" htmlFor="name">Weight</Label>
                    <Input id="name" defaultValue="" disabled />
                  </div>
                  ...
                  <div className="space-y-1">
                    <Label className="text-sm font-semibold" htmlFor="name">MTRL Type</Label>
                    <Input id="name" defaultValue="" disabled />
                  </div>
                </>
              )}
      ...
      {openMtrlInforScanQrDialog && (
        <MtrlInforScanQrDialog
          ...
          haldleOpenMtrlInforScanQrDialog={
            haldleOpenMtrlInforScanQrDialog
          }
        />
      )}
